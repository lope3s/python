...
print("""Like other collections, sets support x in set, len(set) and
...
print("""There are currently two built-in set types, set and frozenset.
...
print("""Two sets are equal if every element of each set is contained in
